...
public class JDBCAplicacionDAO implements IAplicacionDAO{
	...
	public void deleteAplication(Aplicacion aplicacion) {
		...
		try{
			stm = con.prepareStatement(sql);
			stm.setInt(0,new Integer(aplicacion.getIDAplicacion()));
	...
	private void insertAplicationTagRelation(Connection con,Aplicacion aplicacion,Tag tag){
		PreparedStatement stm = null;
		...
		try{
			stm = con.prepareStatement(sql);
			stm.setInt(0,new Integer(aplicacion.getIDAplicacion()));
			stm.setInt(1,new Integer(tag.getIdTag()));
...
//		}
	...
	private void deleteAplicationTagRelation(Connection con,Aplicacion aplicacion){
		PreparedStatement stm = null;
